...
public class SpotItineraryAdapter extends BaseAdapter{
	private Context context;
    private static LayoutInflater inflater=null;
    ArrayList<Spot> items;
    //public ImageLoader imageLoader;
 
    public SpotItineraryAdapter(Context context, ArrayList<Spot> items) {
	...
	public View getView(int index, View convertView, ViewGroup parent) {
		...
		//if (view == null){
			//Log.d("test", "test");
			holder = new MyTag();
			view = inflater.inflate(R.layout.list_row_spot_itinerary, parent, false);
