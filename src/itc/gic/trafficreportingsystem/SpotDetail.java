...
public class SpotDetail extends SherlockActivity {
	
	private int indexSpot=0;
	//private ArrayList<Spot> spotList = new ArrayList<Spot>();
	private Spot spot;
	private ImageView spot_img, degree_img;
	private TextView spot_name, spot_address, degree, text_number_report, number_report;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyTool.getDegreeStatus(SpotDetail.this, spot.getDegree(), degree_img, degree);
		...
		/*if (MyApplication.loggedIn) {
			btn_report.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					final Dialog dialog = new Dialog(SpotDetail.this);
					...
					btn_submit.setOnClickListener(new OnClickListener() {
						@Override
						public void onClick(View v) {							
							SendData send_report = new SendData(SpotDetail.this, dialog, pb);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		switch(item.getItemId()){ 
			...
			case R.id.map:
				...
				Intent i = new Intent(SpotDetail.this, SpotDetailOnMap.class);
				Bundle bundle = new Bundle();
		        bundle.putSerializable("spot_detail_list", spotList);
		        i.putExtras(bundle);
