...
public class ItinerarySpotAdapter extends BaseAdapter{
	private Context context;
    private static LayoutInflater inflater=null;
    ArrayList<Spot> items;
    //public ImageLoader imageLoader;
 
    public ItinerarySpotAdapter(Context context, ArrayList<Spot> items) {
	...
	public View getView(int index, View convertView, ViewGroup parent) {
		...
		for(int i:AddSpotToItinerary.spotToAdd){
			
			if(item.getId()==i){
				view.setBackgroundColor(Color.WHITE);
				Log.e("=====> To white color: ","kkkkkkkkkkkkk");
			}
		}
